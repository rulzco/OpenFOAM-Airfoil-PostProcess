# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 12:53:52 2019
...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 14 17:57:05 2019
...
for a in alfas:
	...
	df = pd.read_csv(source_route+'data/wale_'+theta+'.csv' )
	df2 = pd.read_csv(source_route+'data/wale_r1_'+theta+'.csv' )
	df3 = pd.read_csv(source_route+'data/wale_r2_'+theta+'.csv' )
	...
	#plt.legend(['Cp'])
	plt.legend(['$C_p$ Wale','$C_p$ Wale ac $0.1c$','$C_p$ Wale ac $0.03c$','$C_p$ $k-\Omega$ 0.1c','$C_p$ $k-\Omega$ 0.03c'])
	plt.xlabel('X (m)')
	plt.ylabel('Cp')
	...
	plt.savefig('RANS/figs/LES/Cpx_wale_'+theta+'.png')
	...
	# add text labels to the plot
	plt.legend(['$\Omega$ Wale','$\Omega$ Wale ac $0.1c$','$\Omega$ Wale ac $0.03c$','$\Omega$ RANS 0.1c','$\Omega$ RANS 0.03c'])
	plt.xlabel('X (m)')
	...
	# save the figure as a PNG file 
	plt.savefig('RANS/figs/LES/omega_wale_'+theta+'.png')
	# show the figure on the screen
	plt.show()
	...
	#plt.gca().invert_yaxis()
	# add text labels to the plot
	plt.legend(['$C_f$ Wale','$C_f$ Wale ac $0.1c$','$C_f$ Wale ac $0.03c$','$C_f$ $k-\Omega$ SST 0.1c','$C_f$ $k-\Omega$ SST 0.03c'])
	plt.xlabel('X (m)')
	plt.ylabel('Cf')
	...
	# save the figure as a PNG file 
	plt.savefig('RANS/figs/LES/Cfx_wale_'+theta+'.png')
	# show the figure on the screen
	plt.show()
