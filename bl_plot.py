...
for a in alfas2:
	...
	df = pd.read_csv(source_route+'bl_smago_'+theta2+'.csv' )
	df2 = pd.read_csv(source_route+'bl_smago_r1_'+theta2+'.csv' )
	df3 = pd.read_csv(source_route+'bl_smago_r2_'+theta2+'.csv' )
	#------------------------BL RANS DATA--------------------------------------------------
	...
	plt.legend(['Sin actuador Smagorinsky','Actuador 0.1x/c Smagorinsky','Actuador 0.03x/c Smagorinsky'])
	plt.xlabel('U (m/s)')
