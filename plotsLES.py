...
for a in alfas:
	...
	#plt.legend(['Cp'])
	plt.legend(['$C_p$ Smagorinsky','$C_p$ Smagorinsky ac $0.1c$','$C_p$ Smagorinsky ac $0.1c$','$C_p$ $k-\Omega$ 0.1c','$C_p$ $k-\Omega$ 0.03c'])
	plt.xlabel('X (m)')
	plt.ylabel('Cp')
	...
	# add text labels to the plot
	plt.legend(['$\Omega$ Smagorinsky','$\Omega$ Smagorinsky ac $0.1c$','$\Omega$ Smagorinsky ac $0.1c$','$\Omega$ RANS 0.1c','$\Omega$ RANS 0.03c'])
	plt.xlabel('X (m)')
