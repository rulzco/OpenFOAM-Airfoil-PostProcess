...
for a in alfas:
	...
	yPlus_2 = df3['yPlus']
	#-----------------------Cp plot------------------------------------------------
	plt.figure(num=None, figsize=(8, 6), dpi=90, facecolor='w', edgecolor='w')
	#plt.subplot(2, 1, 1)
	...
	#plt.legend(['Cp'])
	plt.legend(['$C_p$','$C_p$ ac $0.1x/c$','$C_p$ ac $0.03x/c$'])
	plt.xlabel('X (m)')
	plt.ylabel('$C_p$')
	plt.title('$C_p$ vs X  %a°' %a)
	plt.grid(True)
	...
	# add text labels to the plot
	plt.legend(['$\Omega$','$\Omega$ ac $0.1x/c$','$\Omega$ ac $0.03x/c$'])
	plt.xlabel('X (m)')
	...
	#plt.gca().invert_yaxis()
	# add text labels to the plot
	plt.legend(['$C_f$','$C_f$ ac $0.1x/c$','$C_f$ ac $0.03x/c$'])
	plt.xlabel('X (m)')
	plt.ylabel('$C_f$')
	plt.title('$C_f$ vs X %a°' %a)
	plt.grid(True)
...
# add text labels to the plot
plt.legend(['$C_l$','$C_l$ ac $0.1x/c$','$C_l$ ac $0.03x/c$'])
plt.xlabel('$\\alpha$')
plt.ylabel('$C_l$')
...
# add text labels to the plot
plt.legend(['$C_d$','$C_d$ ac $0.1x/c$','$C_d$ ac $0.03x/c$'])
plt.xlabel('$\\alpha$')
plt.ylabel('$C_d$')
